...
<!--Amazon Image Logo-->
      <div class="d-flex flex-row justify-content-center">
        <div class="row">
          <div class="col-md">
            <img class="img_1" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/2221140/amazonimg.png" alt="Amazon Logo"/>
          </div><!--Col 1 End-->
        </div><!--Row 1 End-->
      </div><!--Container End-->
<!--Amazon Image Logo-->
...
<!--Form-->
  ...
  <div class="form-group">
    ...
    <div class="form-group">
      ...
      <img id="amazon-img" src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/2221140/newtoamazon1.svg" alt="Amazon Image">
    </div>
  </div>
